...
class JetInfo {
    public:
        ...
        void RegisterTree(TTree *root, std::string name="JetInfo") {
            root->Branch((name+".Size").c_str()               , &Size               , (name+".Size/I").c_str()                 );
            root->Branch((name+".pfCombinedInclusiveSecondaryVertexV2BJetTags").c_str()               , &pfCombinedInclusiveSecondaryVertexV2BJetTags[0]               , (name+".pfCombinedInclusiveSecondaryVertexV2BJetTags["+name+".Size]/I").c_str()                 );
            root->Branch((name+".Index").c_str()               , &Index[0]             , (name+".Index["+name+".Size]/I").c_str()          );
        ...
        void Register(TTree *root, std::string name="JetInfo") {
            ...
            root->SetBranchAddress((name+".pfCombinedInclusiveSecondaryVertexV2BJetTags").c_str()         , &pfCombinedInclusiveSecondaryVertexV2BJetTags[0]               );
