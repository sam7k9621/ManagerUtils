...
*******************************************************************************/
    ...
    bool SampleMgr::passElPt( const double& pt ) {
        return ( _lep.Pt[_idx] > pt );
    }
    
    bool SampleMgr::passElEta( const double& eta ) {
    ...
    bool SampleMgr::passElIDLoose() {
        return _lep.EgammaCutBasedEleIdLOOSE[_idx];
    }
    
    bool SampleMgr::passElIDTight() {
